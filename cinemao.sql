...
select a.nome_ator, b.nome_filme from tbl_Filme_e_Ator c join tbl_ator a on c.fk_id_ator = a.id_ator join tbl_filme b on c.fk_id_filme = b.id_filme;

select a.nome_ator, b.nome_filme from tbl_Filme_e_Ator c join tbl_ator a on c.fk_id_ator = a.id_ator join tbl_filme b on c.fk_id_filme = b.id_filme order by nome_ator;

select a.nome_ator, b.nome_filme from tbl_Filme_e_Ator c join tbl_ator a on c.fk_id_ator = a.id_ator join tbl_filme b on c.fk_id_filme = b.id_filme order by nome_ator, nome_filme;
/******************************** EXERCÍCIOS *****************************************/
